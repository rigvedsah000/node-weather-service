...
const forecast = (latitude, longitude, callback) => {
    ...
    const url = 'http://api.weatherstack.com/current?access_key=8a1e1714cacba96e2a3b38d6e5cc1fcf&query=' + encodeURIComponent(longitude) + ',' + encodeURIComponent(latitude) + '&units=s'
